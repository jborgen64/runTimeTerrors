...
router.get("/api/comicvine/issues/:id/", function(req, res) {
  var url =
    "https://comicvine.gamespot.com/api/issues/4005-" +
    req.params.id +
    "/?api_key=6d585bd220603de589bc80707c5dbd370ac7f030&format=json&sort=cover_date:desc";
  axios
    .get(url)
    .then(response => {
      console.log(response.data);
...
router.get("/api/comicvine/character/:id/", function(req, res) {
  var url =
    ...
    req.params.id +
    "/?api_key=6d585bd220603de589bc80707c5dbd370ac7f030&format=json";
  axios
    .get(url)
    .then(response => {
      console.log(response.data);
